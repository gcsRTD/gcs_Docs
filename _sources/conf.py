...
#pdf_documents =[('index', u'documentName', u'Nome do Documento', u'GCS Document'),]
...
project = 'GCS DOCUMENTS'
copyright = '2018, GCS INTERNAL'
author = 'Rui Pereira'
...
# (source start file, target namee, title, author,
